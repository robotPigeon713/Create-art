...
The code from the ipynb file addresses the setup of a conda environment, 
as well as the training and evaluation of a convolutional neural network with two
